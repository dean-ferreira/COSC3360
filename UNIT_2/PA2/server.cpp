...
void fireman(int) { while (waitpid(-1, NULL, WNOHANG) > 0); } // Referenced this function from the in-lecture program
...
int main(int argc, char *argv[])
{
    ...
    while (true)
    {
        ...
        if (fork() == 0)
        {
            ...
            // Receive the symbol's probability and the value of f(x) from the client
            ...
            // Use SFE algo to generate the binary code of the symbol
            ...
            // Return the binary code to the client program
